package se.sundsvall.esigning.integration.engine;
...
class ExternalTaskClientBaseUrlDerivationTest {
	...
	@Test
	void pollUrlDefaultsToCamundaWhenTypeIsNotSet() {
		contextRunner.run(context -> assertThat(context.getEnvironment().getProperty(POLL_URL)).isEqualTo(CAMUNDA_URL));
	}
}
