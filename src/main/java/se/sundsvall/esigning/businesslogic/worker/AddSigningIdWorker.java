...
public class AddSigningIdWorker extends AbstractWorker {
	...
	AddSigningIdWorker(EngineClient engineClient, FailureHandler failureHandler, Gson gson, DocumentClient documentClient) {
	...
	public void executeBusinessLogic(ExternalTask externalTask, ExternalTaskService externalTaskService) {
		...
		try {
			...
			metaData.add(toDocumentMetadata(DOCUMENT_METADATA_KEY_SIGNING_ID, externalTask.getVariable(PROCESS_VARIABLE_COMFACT_SIGNING_ID)));
