...
public class ProcessResource {
	...
	@PostMapping(path = "start", consumes = APPLICATION_JSON_VALUE, produces = { APPLICATION_JSON_VALUE, APPLICATION_PROBLEM_JSON_VALUE })
	...
	public ResponseEntity<StartResponse> startProcess(
		...
		final var startProcessResponse = new StartResponse(service.startProcess(request));
		LOGGER.info("Request for start of e-signing process for request {} has been received, resulting in an instance with id {}", request, startProcessResponse.getProcessId());
